...
![RAW Browser Banner](https://github.com/sharp4real/rawbrowser/blob/main/banner.png)
...
![Screenshot](https://github.com/sharp4real/rawbrowser/blob/main/Screenshot.png)

## Core Features

**Privacy by Default**
- Network-level ad/tracker blocking with 100k+ rules
- Fingerprint spoofing (user agent, screen, hardware)
- WebRTC IP leak protection
- Automatic tracking parameter stripping
- Permission guard (geolocation, notifications denied by default)
